...
{
	GLhandleARB vertexShaderHandle;//GLhandle==GLuint
...
//	vertexShaderHandle   = loadShader("Mandelbrot.vert",GL_VERTEX_SHADER);
//	fragmentShaderHandle = loadShader("Mandelbrot.frag",GL_FRAGMENT_SHADER);
	

	shadowShaderId = glCreateProgram();
	glAttachShader(shadowShaderId,vertexShaderHandle);
	glAttachShader(shadowShaderId,fragmentShaderHandle);	
	glLinkProgram(shadowShaderId);
	shadowMapUniform = glGetUniformLocation(shadowShaderId,"ShadowMap");		

}//end loadShadowShader()
